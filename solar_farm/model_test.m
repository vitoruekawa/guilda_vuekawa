...
%% Plot simulation results
    ...
    ylabel('Rate of change from steady state value(%)','FontSize',15);
    ylim([-20,20])
    legend({'Real part of impedance','Imaginary part of impedance'},'Location','southeast')
    title('Change in value of impedance of bus 3','FontSize',20)
    hold off;
    ...
    title(['Penetration gamma = ', num2str(gamma_pv)],'FontSize',20)
    hold off